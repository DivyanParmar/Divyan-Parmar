...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="overflow-x-hidden py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Let's Build Something Amazing</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-2xl p-6 sm:p-8">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className={`group w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform flex items-center justify-center mb-2 ${
                    isSubmitting ? 'opacity-60 cursor-not-allowed' : 'hover:scale-105'
                  }`}
                >
                  {isSubmitting ? (
